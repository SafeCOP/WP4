...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<CAM_simplified>)))
  ...
  "9432af28627cff95b2a09a36b5176ec0")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'CAM_simplified)))
  "Returns md5sum for a message object of type 'CAM_simplified"
  "9432af28627cff95b2a09a36b5176ec0")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<CAM_simplified>)))
  ...
  (cl:format cl:nil "# IDs~%~%string car_name~%~%# Reference Position~%#int32 latitude~%#int64 longitude~%#int32 altitude_altitudeValue~%~%float32 latitude~%float64 longitude~%float32 altitude_altitudeValue~%~%# BasicVehicleContainerHighFrequency (Simplified)~%~%#uint16 heading_headingValue~%#uint16 speed_speedValue~%float32 heading_headingValue~%float32 speed_speedValue~%~%int8 driveDirection~%~%#int16 steeringWheelAngle_steeringWheelAngleValue~%float32 steeringWheelAngle_steeringWheelAngleValue~%~%float32 gasPedalPercent_Value~%float32 brakePedalPercent_Value~%~%~%~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'CAM_simplified)))
  "Returns full string definition for message of type 'CAM_simplified"
  (cl:format cl:nil "# IDs~%~%string car_name~%~%# Reference Position~%#int32 latitude~%#int64 longitude~%#int32 altitude_altitudeValue~%~%float32 latitude~%float64 longitude~%float32 altitude_altitudeValue~%~%# BasicVehicleContainerHighFrequency (Simplified)~%~%#uint16 heading_headingValue~%#uint16 speed_speedValue~%float32 heading_headingValue~%float32 speed_speedValue~%~%int8 driveDirection~%~%#int16 steeringWheelAngle_steeringWheelAngleValue~%float32 steeringWheelAngle_steeringWheelAngleValue~%~%float32 gasPedalPercent_Value~%float32 brakePedalPercent_Value~%~%~%~%~%~%~%"))

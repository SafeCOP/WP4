...
class CAM_simplified(genpy.Message):
  _md5sum = "9432af28627cff95b2a09a36b5176ec0"
...
"""
  __slots__ = ['car_name','latitude','longitude','altitude_altitudeValue','heading_headingValue','speed_speedValue','driveDirection','steeringWheelAngle_steeringWheelAngleValue','gasPedalPercent_Value','brakePedalPercent_Value']
  _slot_types = ['string','float32','float64','float32','float32','float32','int8','float32','float32','float32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       car_name,latitude,longitude,altitude_altitudeValue,heading_headingValue,speed_speedValue,driveDirection,steeringWheelAngle_steeringWheelAngleValue,gasPedalPercent_Value,brakePedalPercent_Value

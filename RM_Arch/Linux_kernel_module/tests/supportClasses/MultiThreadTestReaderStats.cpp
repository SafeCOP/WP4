...
MultiThreadTestReaderStats::MultiThreadTestReaderStats() : MultiThreadTestStats()
{
    number_of_gaps=0;
    number_of_false_gaps=0;
    number_of_empty_reads=0;
...
void MultiThreadTestReaderStats::update_gap_time(struct timespec &start, struct timespec &end) {

#ifndef KERNEL_MULTITHREADTESTREADERSTATS_H
#define KERNEL_MULTITHREADTESTREADERSTATS_H
...
public:
    ...
    */
     ...
     */
    void update_gap_time(struct timespec &start, struct timespec &end);
...
#endif //KERNEL_MULTITHREADTESTREADERSTATS_H
